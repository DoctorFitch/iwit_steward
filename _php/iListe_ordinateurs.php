...
// DB table to use
$table = 'materiel_type_ordinateur';
...
$columns = array(
    ...
    array(
        'db'        => 'materiels_ordinateur_carteGraphique',
        'dt'        => 4,
        'formatter' => function( $d, $row ) {
            return '<span class="id" href="mailto:'.$d.'" id="id" data-type="text" data-pk="'.$row['materiels_id'].'" table_id="societes_id" data-original-title="">'.utf8_encode($d).'</span> ';
        }
    ),
    array(
        'db'        => 'materiels_ordinateur_processeur',
        'dt'        => 5,
        'formatter' => function( $d, $row ) {
            return '<span class="id" id="id" data-type="text" data-pk="'.$row['materiels_id'].'" table_id="societes_id" data-original-title="">'.utf8_encode($d).'</span> ';
        }
    ...
    array(
        'db'        => 'materiels_ordinateur_stockage',
        'dt'        => 6,
        'formatter' => function( $d, $row ) {
            return '<span class="id" id="id" data-type="text" data-pk="'.$row['materiels_id'].'" table_id="societes_id" data-original-title="">'.utf8_encode($d).'</span> ';
        }
    ...
    array(
        'db'        => 'materiels_ordinateur_carteMere',
        'dt'        => 7,
        'formatter' => function( $d, $row ) {
            return '<span class="id" id="id" data-type="text" data-pk="'.$row['materiels_id'].'" table_id="societes_id" data-original-title="">'.utf8_encode($d).'</span> ';
        }
    ...
    array(
        'db'        => 'materiels_ordinateur_tailleEcran',
        'dt'        =>8,
        'formatter' => function( $d, $row ) {
            return '<span class="id" id="id" data-type="text" data-pk="'.$row['materiels_id'].'" table_id="societes_id" data-original-title="">'.utf8_encode($d).'</span> ';
        }
