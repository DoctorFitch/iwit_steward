...
<!-- Début du formulaire -->
<form action="./php/iAjout_module.php" id="ajoutModule" class="smart-form" novalidate="novalidate" method="post"
      name="ajoutSociete">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <section class="col col-10">
                    <select multiple style="width:100%" class="select2" id="id_utilisateurs" name="id_utilisateurs[]" required>
