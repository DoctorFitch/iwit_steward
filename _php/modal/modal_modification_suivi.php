<?php require_once("../inc/init.php"); $func = new Functions(); $id = $_POST['id']; $rang = $pdo->sqlRow("SELECT * FROM view_suivis WHERE suivis_id = ?", array($id)) ?>
...
<!-- Début du formulaire -->
<form action="./php/iModification_suivi.php" id="ajoutSuivi" class="smart-form" novalidate="novalidate"
            ...
            <div class="row">
                ...
                <section class="col col-4">
                    <label class="input fe"><i class="icon-prepend fa fa-cogs"></i>
                        <input type="text" name="suivi_duree" placeholder="en heures" required value="<?php echo $rang['suivis_duree']; ?>">
                    </label>
                </section>
            </div>
...
<script type="text/javascript">
    ...
    var pagefunction = function () {
        ...
        $('#projet_selection').change(function () {
            $.ajax({
                type: $('#ajoutSuivi').attr('method'),
                url: './php/iSelect_projets_modules.php',
