...
<!-- Début du formulaire -->
<form action="./php/iModification_maintenance.php" id="modificationMaintenance" class="smart-form" novalidate="novalidate"
                    ...
                    <select class="select2" name="select_utilisateur" id="select_utilisateur">
                        ...
                        foreach ($select_utilisateur as $utilisateurs) {
                            if ($utilisateurs['societes_id'] != $id_generique) {
                                if (!empty($id_generique)) { echo "</optgroup>"; }
                ...
                <section class="col col-4">
                    <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                        <input type="text" class="form-control datepicker" name="maintenance_date"
                               placeholder="Date maintenance" required value="<?php echo $rang['maintenances_date'] ; ?>">
                    </label>
                </section>
                ...
                <section class="col col-4">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="maintenance_heure" id="clockpicker" type="text"
                               placeholder="&nbsp;&nbsp;Heure de la maintenance" data-autoclose="true" value="<?php echo $func->dateFR($rang['maintenances_date'],6) ; ?>">
                    </div>
                </section>
            </div>
            ...
            <div class="row">
                ...
                <section class="col col-4">
                    <label class="input fe"><i class="icon-prepend fa fa-cogs"></i>
                        <input type="text" name="maintenance_duree" placeholder="Durée de la maintenance" required" value="<?php echo $rang['maintenances_duree'] ; ?>">
                    </label>
                </section>
            </div>
...
<script type="text/javascript">
    ...
    function users() {
        ...
        $.ajax({
            type: $('#modificationMaintenance').attr('method'),
            url: './php/iSelect_utilisateurs_maintenance.php',
            data: $('#modificationMaintenance').serialize(),
            dataType: 'json',
            success: function (data) {
