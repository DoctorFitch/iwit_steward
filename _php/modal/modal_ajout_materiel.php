        ...
        <div class="row">
            ...
            <section class="col col-4 hide" id="maintenance_debut">
                <div class="input-group">
                    <input class="form-control" id="clockpicker_heureDebut" type="text" name="maintenance_debut" placeholder="&nbsp;&nbsp;Sélectionner l'heure de début" data-autoclose="true">
            ...
            <section class="col col-4 hide" id="maintenance_fin">
                <div class="input-group">
                    <input class="form-control" id="clockpicker_heureFin" type="text" name="maintenance_fin" placeholder="&nbsp;&nbsp;Sélectionner l'heure de fin" data-autoclose="true">
                    <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                </div>
            </section>
        ...
        <div class="row">
            ...
            <section class="col col-10 hide" id="commentaire">
                <label class="textarea">
                    <textarea rows="5" name="commentaire"  placeholder="Commentaire"></textarea>
                </label>
            </section>
        </div>
    </fieldset>
