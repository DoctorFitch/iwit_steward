...
if ($count != 0) {
    ...
    $pdo->sql("INSERT INTO `historiques` (
                ...
                ?,
                ?,
                NOW())", array(ASSETS_URL . $_SESSION['utilisateur_photo'], "Ajout d'une société par " . $_SESSION['utilisateur_prenom'] . ' ' . $_SESSION['utilisateur_nom'] , $nom_societe , 'index.php?p=modules/locaux', '1', 'fa-suitcase'));
