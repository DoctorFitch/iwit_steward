...
if ($count != 0) { // Si le produit existe
    ...
    $pdo->sql("INSERT INTO `historiques` (
                ...
                ?,
                ?,
                NOW())", array(ASSETS_URL . $_SESSION['utilisateur_photo'], "Ajout d'un module par " . $_SESSION['utilisateur_prenom'] . ' ' . $_SESSION['utilisateur_nom'] , $module_nom, 'index.php?p=modules/projets', '1', 'fa-users'));
}
