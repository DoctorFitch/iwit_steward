...
<!-- Début du formulaire -->
<form action="modules/projets/ajax/iModification_module.php" id="modificationModule" class="smart-form" novalidate="novalidate"
      method="post"
      name="ajoutSociete">
            ...
            <div class="row">
                ...
                <section class="col col-10">
                    <label class="textarea">
                        <textarea rows="5" name="commentaire_module" placeholder="Description" required"><?php echo $rang['projets_modules_commentaires']; ?></textarea>
                    </label>
                </section>
            </div>
        </fieldset>
...
$(document).ready(function(){
    ...
    var pagefunction = function () {
        ...
        function users() {
            ...
            $.ajax({
                type: $('#modificationModule').attr('method'),
                url: 'modules/projets/ajax/iSelect_utilisateurs_modification_module.php',
                data: $('#modificationModule').serialize(),
                dataType: 'json',
                success: function (data) {
