<?php require_once('../../../lib/config.php'); $id_utilisateur = $_SESSION['utilisateur_id'];?>

<!-- Titre du modal -->
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
    </button>
    <h4 class="modal-title" id="myModalLabel">Ajout d'un suivi</h4>
</div>

<!-- Début du formulaire -->
<form action="modules/productions/ajax/iAjout_suivi.php" id="ajoutSuivi" class="smart-form" novalidate="novalidate"
                    ...
                    <div class="icon-addon" style="width: 122%;">
                        <select class="form-control" name="select_utilisateurs" id="select_utilisateurs" required>
                            ...
                            while ($row = $select->fetch()) {
                                $selected = ($row['iwit_utilisateur_id'] == $id_utilisateur) ? 'selected' : '';
                ...
                <section class="col col-3">
                    <div class="icon-addon" style="width: 122%;">
                        <select class="form-control" name="projet_selection" id="projet_selection" required>
                            ...
                            while ($row = $select->fetch()) {
                                echo "<option value=" . $row['projets_id'] . ">" . $row['projets_nom'] . "</option>";
                            }
                            ?>
                        </select>
            ...
            submitHandler: function (ev) {
                $(ev).ajaxSubmit({
                    ...
                    success: function (data) {
                        smallBox('Ajout réussi !', 'Le suivis à correctement été ajouté.', 'success');
                        setTimeout(function () {
