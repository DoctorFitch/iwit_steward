...
$pdo->sql("INSERT INTO `historiques` (
                ...
                ?,
                ?,
                NOW())", array(ASSETS_URL . $_SESSION['utilisateur_photo'], "Modification d'un suivi par " . $_SESSION['utilisateur_prenom'] . ' ' . $_SESSION['utilisateur_nom'] , $module_selection , 'index.php?p=modules/productions', '2', 'fa-desktop'));
