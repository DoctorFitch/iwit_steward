...
if ($count != 0) { // Si l'utilisateur existe
    ...
    $pdo->sql("INSERT INTO `historiques` (
                ...
                ?,
                ?,
                NOW())", array(ASSETS_URL . $_SESSION['utilisateur_photo'], "Modification d'un utilisateur par " . $_SESSION['utilisateur_prenom'] . ' ' . $_SESSION['utilisateur_nom'] , $utilisateur_nom , 'index.php?p=modules/utilisateurs', '2', 'fa-user'));
}
