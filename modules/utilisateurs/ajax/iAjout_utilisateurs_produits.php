...
if ($count != 0) { // Si le produit existe
    ...
    $pdo->sql("INSERT INTO `historiques` (
                ...
                ?,
                ?,
                NOW())", array(ASSETS_URL . $_SESSION['utilisateur_photo'], "Ajout d'un produit à un utilisateur par " . $_SESSION['utilisateur_prenom'] . ' ' . $_SESSION['utilisateur_nom'] , "ID produit : "  . $produit . " ID utilisateur : " . $utilisateurs_produits_id, 'index.php?p=modules/utilisateurs', '1', 'fa-cube'));
