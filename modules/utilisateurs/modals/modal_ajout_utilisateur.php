...
<!-- Début du formulaire -->
<form action="modules/utlisateurs/ajax/iAjout_utilisateur.php" id="ajoutUtilisateur" class="smart-form" novalidate="novalidate"
...
//            $('#state-disabled').addClass("input");
    ...
    $('#select_entreprise').change(function () {
        $.ajax({
            type: $('#ajoutUtilisateur').attr('method'),
            url: 'modules/utilisateurs/ajax/iSelect_entreprise.php',
