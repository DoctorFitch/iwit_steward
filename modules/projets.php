...
<button type="button" class="well" onclick="ouvertureAjout_projet();"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Nouveau
    projet
</button>
        ...
        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form id="tableau">
                        <table id="listing_projets" class="table table-striped table-bordered table-hover"
                               width="100%">
                            <thead>
                            <tr>
                                <th>Société</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var pagefunction = function () {
            ...
            var responsiveHelper_listing_projets = undefined;
            ...
            $('#listing_projets').dataTable({
                ...
                "preDrawCallback": function () {
                    if (!responsiveHelper_listing_projets) {
                        responsiveHelper_listing_projets = new ResponsiveDatatablesHelper($('#listing_projets'), breakpointDefinition);
                    }
                },
                "rowCallback": function (nRow) {
                    responsiveHelper_listing_projets.createExpandIcon(nRow);
                },
                "ajax": "modules/projets/ajax/iListe_projets.php",
                "drawCallback": function (oSettings) {
                    responsiveHelper_listing_projets.respond();
                },
                "language": {
    ...
    function ouvertureAjout_projet() {
        $.ajax({
            url: 'modules/projets/modals/modal_ajout_projet.php',
            type: 'POST',
            data: '',
            dataType: 'html',
    ...
    function ouvertureModification_projet(paramId) {
        window.location = 'index.php?p=modules/modification_projet&id=' + paramId;
    }

    function suppressionLigne(paramId) {
        $.SmartMessageBox({
            title: "Attention !",
            content: "Vous êtes sur le point de supprimer ce projet, confirmer ?",
            buttons: '[Non][Oui]'
        }, function (ButtonPressed) {
            console.log(paramId);
            if (ButtonPressed === "Oui") {
                $.ajax({
                    url: 'modules/projets/modals/modal_suppression_projet.php',
                    type: 'POST',
                    data: {'id': paramId},
                    dataType: 'html',
                    success: function (contenu) {
                        smallBox('Suppression', "Le projet à correctement été supprimé.", 'success');
                        setTimeout(function () {
            ...
            if (ButtonPressed === "Non") {
                smallBox('Suppression', "Le projet n'à pas été supprimé.", 'warning');
            }
        });
    }
