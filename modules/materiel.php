...
<button type="button" class="well" onclick="ouvertureAjout_produit();"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Nouveau
    produit
</button>
        ...
        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
            ...
            <div>
                ...
                <div class="widget-body no-padding">
                    <form id="tableau">
                        <table id="listing_materiel" class="table table-striped table-bordered table-hover"
                               width="100%">
                            <thead>
                            <tr>
                                <th>Type</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var pagefunction = function () {
            ...
            var responsiveHelper_listing_materiel = undefined;
            ...
            $('#listing_materiel').dataTable({
                ...
                "preDrawCallback": function () {
                    if (!responsiveHelper_listing_materiel) {
                        responsiveHelper_listing_materiel = new ResponsiveDatatablesHelper($('#listing_materiel'), breakpointDefinition);
                    }
                },
                "rowCallback": function (nRow) {
                    responsiveHelper_listing_materiel.createExpandIcon(nRow);
                },
                "aoColumns": [
                    {sWidth: ""},
                    {sWidth: ""},
                ...
                "ajax": "modules/materiels/ajax/iListe_materiels.php",
                "drawCallback": function (oSettings) {
                    responsiveHelper_listing_materiel.respond();
                },
                "language": {
    ...
    function ouvertureAjout_produit() {
        $.ajax({
            url: 'modules/materiels/modals/modal_ajout_produit.php',
            type: 'POST',
            data: '',
            dataType: 'html',
    ...
    function ouvertureModification_produit(paramId) {
        $.ajax({
            url: 'modules/materiels/modals/modal_modification_produit.php',
            type: 'POST',
            data: {'id': paramId},
            dataType: 'html',
            success: function (contenu) {
    ...
    function suppressionLigne(paramId) {
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Oui") {
                $.ajax({
                    url: 'modules/materiels/modals/modal_suppression_produit.php',
                    type: 'POST',
                    data: {'id': paramId},
                    dataType: 'html',
                    success: function (contenu) {
            ...
            if (ButtonPressed === "Non") {
                smallBox('Suppression', "Le produit n'à pas été supprimé.", 'warning');
            }
        });
    }
