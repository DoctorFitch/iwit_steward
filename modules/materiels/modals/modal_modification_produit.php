...
$id = $_POST['id'];
$rang = $pdo->sqlRow("SELECT * FROM produits WHERE produits_id = ?", array($id));
...
<!-- Début du formulaire -->
<!-- Début du formulaire -->
<form action="modules/materiels/ajax/iModification_produit.php" id="ajoutProduit" class="smart-form"
      novalidate="novalidate"
      method="post" name="ajoutProduit">

    <fieldset>
        <!-- ID utilisateur -->
        <input type="hidden" name="produits_id" value="<?php echo $id; ?>"/>

        <div class="row">
            <section class="col col-4">
                <img class="img-responsive" src="<?php echo $rang['produits_image']; ?>">
            </section>
            ...
            <section class="col col-5">
                <label class="input"> <i class="icon-prepend fa fa-font"></i>
                    <input type="text" name="nom_produit" id="licence"
                           placeholder="Nom"
                           required" value="<?php echo $rang['produits_nom']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <div class="icon-addon" style="width: 116%;">
                    <select class="form-control" name="type_produit" id="type_produit" required>
                        ...
                        while ($row = $select->fetch()) {
                            $type_produit_selected = $pdo->sqlValue("SELECT produits_type FROM produits WHERE produits_id = ?", array($id));
                            $selected = ($row['produits_type_id'] == $type_produit_selected) ? 'selected' : '';
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-barcode"></i>
                    <input type="text" name="reference_produit" id="reference_produit"
                           ...
                           required" value="<?php echo $rang['produits_reference']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-barcode"></i>
                    <input type="text" name="serie_produit" id="serie_produit"
                           ...
                           required" value="<?php echo $rang['produits_numeroSerie']; ?>">
                </label>
            </section>
        </div>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-user"></i>
                    <input type="text" name="ean_produit" id="login"
                           placeholder="EAN"
                           required" value="<?php echo $rang['produits_EAN']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-archive"></i>
                    <input type="text" name="poids_produit" id="password"
                           placeholder="Poids"
                           required" value="<?php echo $rang['produits_poids']; ?>">
                </label>
            </section>
        </div>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-eur"></i>
                    <input type="text" name="prix_achat_produit" id="url"
                           ...
                           required" value="<?php echo $rang['produits_prixAchatHT']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-eur"></i>
                    <input type="text" name="prix_public_produit" id="url"
                           ...
                           required" value="<?php echo $rang['produits_prixPublicHT']; ?>">
                </label>
            </section>
        </div>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-percent"></i>
                    <input type="text" name="tva_produit" id="url"
                           placeholder="TVA"
                           required" value="<?php echo $rang['produits_tauxTVA']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-percent"></i>
                    <input type="text" name="taxe_produit" id="url"
                           placeholder="Taxe"
                           required" value="<?php echo $rang['produits_taxe']; ?>">
                </label>
            </section>
        </div>
        ...
        <div class="row">
            ...
            <section class="col col-4">
                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                    <input type="text" name="garantie_produit" id="url"
                           ...
                           required" value="<?php echo $rang['produits_garantie']; ?>">
                </label>
            </section>
            ...
            <section class="col col-4">
                <label for="file" class="input input-file">
                    <div class="button"><input type="file" name="photo_produit" id="photo_produit"" onchange="this.parentNode.nextSibling.value = this.value">Chercher</div><input type="text" readonly=""></label>
        ...
        <div class="row">
            ...
            <section class="col col-10">
                <label class="textarea">
                    <textarea rows="5" name="commentaire_produit" id="commentaire" placeholder="Commentaire"><?php echo $rang['produits_commentaire']; ?></textarea>
                </label>
            </section>
        </div>
    </fieldset>
            ...
            submitHandler: function (ev) {
                $(ev).ajaxSubmit({
                    ...
                    success: function (data) {
                        if (data.retour == '1') {
                            smallBox('Impossible', "Une erreur a été rencontré durant les modifications", 'warning');
                        }
                        else {
                            smallBox('Modification effectuée', 'Le produit à correctement été ajouté', 'success');
                            setTimeout(function () {
